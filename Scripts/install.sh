...
curl --retry 5 -o Unity.pkg https://download.unity3d.com/download_unity/b8cbb5de9840/MacEditorInstaller/Unity.pkg
...
curl --retry 5 -o Unity_win.pkg https://download.unity3d.com/download_unity/b8cbb5de9840/MacEditorTargetInstaller/UnitySetup-Windows-Mono-Support-for-Editor-2018.1.1f1.pkg
if [ $? -ne 0 ]; then { echo "Download failed"; exit $?; } fi
